...
/*通过流程定义id获取第一个任务节点*/
    ...
    public Result<Object> getRunningProcess(@RequestParam(required = false) String name,
        ...
        Map<String, String> userMap = allUser.stream().collect(Collectors.toMap(ComboModel::getUsername, ComboModel::getTitle, (value1, value2 )-> value1
        ));
        list.forEach(e -> {
    ...
    /*激活或挂起流程实例*/
    @RequestMapping(value = "/updateInsStatus", method = RequestMethod.GET)
