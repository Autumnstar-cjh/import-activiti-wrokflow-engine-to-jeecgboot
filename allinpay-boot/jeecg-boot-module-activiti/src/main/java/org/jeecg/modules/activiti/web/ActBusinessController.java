...
public class ActBusinessController {
    ...
    public Result add(@RequestBody JSONObject request){
        String procDefId = (String) request.get("procDefId");
        String procDeTitle = (String) request.get("procDeTitle");
        String tableName = (String) request.get("tableName");
        String filedNames = (String) request.get("filedNames");
        ...
        String title = (String) request.get(ActivitiConstant.titleKey);
    ...
    /*获取业务表单信息*/
    @RequestMapping(value = "/getForm", method = RequestMethod.GET, consumes = "application/json")
    public Result getForm(@RequestBody JSONObject request){
        /*保存业务表单数据到数据库表*/
    ...
    public Result editForm(@RequestBody JSONObject request){
        /*保存业务表单数据到数据库表*/
        String tableId = (String) request.get("id");
        actBusinessService.saveApplyForm(tableId,request);
        return Result.ok();
    }
    /*通过id删除草稿状态申请*/
