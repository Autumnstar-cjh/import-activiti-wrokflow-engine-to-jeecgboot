...
// 系统首页数据加载
const indexPageData = (params) => getAction("/home/dayTrxStat/queryData",params);
const areaDataLoad = (params) => postAction("/home/dayTrxStat/areaData",params);

// 系统首页数据加载
const indexPageDataV2= (params) => getAction("/home/dayTrxStatV2/queryData",params);
const areaDataLoadV2 = (params) => postAction("/home/dayTrxStatV2/areaData",params);
export {
  // imgView,
  // doMian,
  addRole,
