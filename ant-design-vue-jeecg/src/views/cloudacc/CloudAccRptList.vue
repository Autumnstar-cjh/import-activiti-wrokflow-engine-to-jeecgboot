<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('云商通账户交易报表')">导出</a-button>
    ...
    <cloudAccRpt-modal ref="modalForm" @ok="modalFormOk"></cloudAccRpt-modal>
  </a-card>
</template>
...
<script>
  ...
  import CloudAccRptModal from './modules/CloudAccRptModal'
  import JDate from '@/components/jeecg/JDate.vue'

  export default {
    name: "CloudAccRptList",
    ...
    data () {
      return {
        ...
        url: {
          list: "/cloudacc/cloudAccRpt/list",
          delete: "/cloudacc/cloudAccRpt/delete",
          deleteBatch: "/cloudacc/cloudAccRpt/deleteBatch",
          exportXlsUrl: "/cloudacc/cloudAccRpt/exportXls",
          importExcelUrl: "cloudacc/cloudAccRpt/importExcel",
        },
        dictOptions:{
        },
      }
