    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="审核状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['auditStatus']" :trigger-change="true" dictCode="audit_status" placeholder="请选择审核状态"/>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        auditStatus:{rules: [{ required: true, message: '请输入审核状态!' }]},
        comment:{},
        },
        url: {
