...
<script>
  ...
  import OkrWorkPlanModal from './modules/OkrWorkPlanModal'
  import ObjectivesModal from './modules/ObjectivesModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        objectivesCount:"0个",
         url: {
          count: "/okr/objectives/countCurUser",
          // listByCurrentUser: "/okr/okrObjectives/listByCurrentUser",
          listByCurrentUser: "/okr/objectives/listByCurrentUser",
          listObjetivesEvent: "/okr/okrObjectivesEvent/list",
          getWorkPlanList:"/plan/workPlan/list",
          getDate:'/plan/workPlan/getDate'
        },
      }
    },
    computed: {
